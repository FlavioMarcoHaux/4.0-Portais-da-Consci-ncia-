...
import { Stethoscope, BrainCircuit, ScanText, BookText, Pill, HeartPulse, BookHeart, Atom, Orbit, Map, Waves, MessageSquareHeart, Wallet, Calculator, MessageSquare, CalendarClock, ClipboardCheck, BookOpen } from 'lucide-react';
...
- **Doença é Dissonância (Baixo Φ):** Doenças, dores, inflamações e sofrimento mental são manifestações de 'dissonância informacional'. São padrões de informação contraditórios ou 'presos' que reduzem a coerência e a eficiência do sistema. O sofrimento não é um erro, but um sinal, uma 'tensão informacional' que impulsiona a busca por um estado mais integrado.
