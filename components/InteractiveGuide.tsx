...
const InteractiveGuide: React.FC = () => {
    ...
    }, [isActive, tourId, step, tour, nextGuideStep, endGuide]);
    ...
    useLayoutEffect(() => {
        ...
        const intervalId = setInterval(() => {
            ...
            if (targetElement && targetElement.offsetWidth > 0) {
                ...
                const scrollTimeout = setTimeout(positionElements, 400); // Wait for scroll
    ...
    }, [currentStep, isActive, endGuide, positionElements, viewportVersion]); // Rerun on viewport change
